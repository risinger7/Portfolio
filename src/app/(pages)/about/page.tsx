...
export default function AboutPage() {
    ...
    return (
        <div className="about-container">
            <div
                className={`about-content-container ${isLoaded ? "loaded" : ""}`}
            >
                <AboutContent />
    ...
    return (
        <div className="about-content about-item">
            ...
            <div className={`${urbanist400.className} about-flex-text`}>
                <p>
                    Hi! I&apos;m Viktor, a fullstack developer with over 2 years
                    of experience building web and mobile applications using
                    React, Next.js, and React Native. I specialize in creating
